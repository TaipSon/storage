    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        internalStoragePhotoAdapter = InternalStoragePhotoAdapter {
            ...
            if(isDeletionSuccessful) {
                ...
                Toast.makeText(this, "Фотография успешно удалена", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this, "Не удалось удалить фотографию", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        val takePhoto = registerForActivityResult(ActivityResultContracts.TakePicturePreview()) {
            ...
            if(isSavedSuccessefully) {
                Toast.makeText(this, "Фотография успешно сохранена", Toast.LENGTH_SHORT).show()
            } else {
        ...
        setupInternalStorageRecylerView()
        loadPhotosFromInternalStorageIntoRecyclerView()
...
readPermissionGranted = hasReadPermission
            ...
            contentResolver.insert(imageCollection, contentValues)?.also { uri ->
                contentResolver.openOutputStream(uri).use { outputStream ->
                    if (bmp.compress(Bitmap.CompressFormat.JPEG, 95, outputStream)) {
                        throw IOException("Не удалось сохранить растровое изображение")
                    }
                }
    ...
    private fun setupInternalStorageRecylerView() = binding.rvPrivatePhotos.apply {
